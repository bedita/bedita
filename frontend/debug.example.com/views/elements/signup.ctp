<form action="<?php e($html->url('/hashjob/user_sign_up'));?>" method="post">
	...
	nome: <input type="email" name="data[Card][name]" size="30"/><br/>
	<br/><input type="submit" value="<?php __("sign up");?>"/>
</form>