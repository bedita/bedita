...
class EventsFakerSeed extends AbstractSeed
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            'date_ranges' => [
                [
                    'start_date' => new FrozenTime($faker->dateTimeBetween('-30 days', '+30 days')),
                    'end_date' => null
                ],
                [
                    'start_date' => new FrozenTime($faker->dateTimeBetween('-7 days', '-2 days')),
                    'end_date' => new FrozenTime($faker->dateTimeBetween('+2 days', '+5 days')),
                ],
            ],
        ];
