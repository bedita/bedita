...
class ProjectModelTest extends TestCase
{
    ...
    public static function endpointPermissionsDiffProvider(): array
    {
        return [
            ...
            'no changes' => [
                [
                    ['endpoint_name' => null, 'application_name' => null, 'role_name' => null, 'permission' => 0],
                    ['endpoint_name' => 'auth', 'application_name' => 'myapp', 'role_name' => 'admin', 'permission' => 15],
                ],
                [
                    ['endpoint_name' => 'auth', 'application_name' => 'myapp', 'role_name' => 'admin', 'permission' => 15],
                    ['endpoint_name' => null, 'application_name' => null, 'role_name' => null, 'permission' => 0],
            ...
            'create, update, remove' => [
                [
                    ['endpoint_name' => null, 'application_name' => null, 'role_name' => null, 'permission' => 0],
                    ['endpoint_name' => 'auth', 'application_name' => 'myapp', 'role_name' => 'admin', 'permission' => 15],
                    ['endpoint_name' => 'home', 'application_name' => null, 'role_name' => null, 'permission' => 9],
                ],
                [
                    ['endpoint_name' => null, 'application_name' => null, 'role_name' => null, 'permission' => 0],
                    ['endpoint_name' => 'auth', 'application_name' => 'myapp', 'role_name' => 'admin', 'permission' => 1],
                    ['endpoint_name' => 'users', 'application_name' => null, 'role_name' => null, 'permission' => 15],
                ],
                [
                    'create' => [
                        ['endpoint_name' => 'users', 'application_name' => null, 'role_name' => null, 'permission' => 15],
