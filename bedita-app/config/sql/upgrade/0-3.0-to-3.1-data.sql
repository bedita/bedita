...
-- remove `object_types` pluginized
DELETE FROM `object_types` WHERE `object_types`.`name` = 'biblio_item' AND `object_types`.`id` =38
DELETE FROM `object_types` WHERE `object_types`.`name` = 'bibliography' AND `object_types`.`id` =19
DELETE FROM `object_types` WHERE `object_types`.`name` = 'book' AND `object_types`.`id` =20