...
$config["projectName"] = "BEdita 3.1 RC"; // override in bedita.cfg

$config["userVersion"] = "BEdita 3.1.RC"; // don't override

$config["majorVersion"] = "3.1.RC"; // don't override -- admin/system
