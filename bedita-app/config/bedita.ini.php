...
$config["projectName"] = "BEdita 3.1 beta"; // override in bedita.cfg

$config["userVersion"] = "BEdita 3.1.beta"; // don't override

$config["majorVersion"] = "3.1.beta"; // don't override -- admin/system
