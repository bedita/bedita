...
FCKConfig.SkinPath = FCKConfig.BasePath + "/skins/bedita/" ;

// Set our sample toolbar.
FCKConfig.ToolbarSets['PluginTest'] = [
	['SourceSimple'],
	['Bold','Italic','Link','Unlink','-','OrderedList','UnorderedList','-','SpecialChar','-', 'FitWindow']
] ;

// Change the default plugin path.
//FCKConfig.PluginsPath = FCKConfig.BasePath.substr(0, FCKConfig.BasePath.length - 7) + 'plugins/' ;
