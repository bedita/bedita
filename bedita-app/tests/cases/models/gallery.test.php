...
class GalleryTestCase extends CakeTestCase {
	...
	function testInsertImagesForGallery() {
		...
		$this->data['file']= array(
			...
			'short_desc' => 'La mosca cavallina ronza dappertutto al galoppo',
		...
		$this->data['file']= array(
			...
			'short_desc' => 'Il leorpente e\' il serpente piu\' velenoso tra i felini...',
		...
		$this->data['file']= array(
			...
			'short_desc' => 'L\'ippotigre - uno su un milione di abitanti',
