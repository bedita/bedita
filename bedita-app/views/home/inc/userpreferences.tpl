...
<tr>
	<td><label class="simple" id="lrealname" for="realname">{t}name{/t}</label></td>	<td><input type="text" id="realname" value="{$BEAuthUser.realname}"  /></td>
</tr>
<tr>
	<td><label class="simple" id="lemail" for="email">{t}email{/t}</label></td>	<td><input type="text" id="email" value="{$BEAuthUser.email}" class="{literal}{email:true}{/literal}" title="{t}Use a valid email{/t}"/></td>
</tr>
...
<tr>
	<td><label class="simple">{t}old psw{/t}</label></td>	<td><input type="password" name="pwd" value="" id="pwd" class="{if isset($userdetail)}{literal}{password:true}{/literal}{else}{literal}{required:true,password:true}{/literal}{/if}" title="{$tr->t($conf->passwdRegexMsg)}"/></td>
</tr>
<tr>
