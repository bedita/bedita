...
<div class="login">
	...
	<fieldset>
		...
		<input class="big" tabindex="2" type="password" name="data[login][passwd]" id="passwd" class="{literal}{ required:true}{/literal}" title="{t}Password is required{/t}" autocomplete="off" />
