...
var message = "{t}Are you sure that you want to delete the news?{/t}" ;
var messageSelected = "{t}Are you sure that you want to delete selected news?{/t}" ;
{literal}
...
<div id="containerPage">
	...
	{if $objects}
	<p class="toolbar">
		{t}News{/t}: {$beToolbar->size()} | {t}page{/t} {$beToolbar->current()} {t}of{/t} {$beToolbar->pages()} &nbsp;
