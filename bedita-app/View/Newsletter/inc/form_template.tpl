...
{else}
	{assign var="templateCSS" value=$this->Html->url('/css/newsletter.css')}
{/if}
...
<form action="{$this->Html->url('/newsletter/saveTemplate')}" method="post" name="updateForm" id="updateForm" class="">
	...
	<div class="htabcontainer" id="templatebody">
		...
		<div class="htabcontent" id="html">
			...
			{else}
				...
				<img src="{$this->Html->webroot}img/{$imagenotizia|default:'px.gif'}" 
