...
<div class="secondacolonna {if !empty($fixed)}fixed{/if}">
	...
	{if $method eq "templates"}
		...
		<ul class="menuleft insidecol bordered">
			<li><a href="{$this->Html->url('/newsletter/viewMailTemplate')}">{t}New template{/t}</a></li>
		</ul>
	...
	{elseif $method eq "newsletters"}
		...
		<ul class="menuleft insidecol">
			<li {if $method eq "view"}class="on"{/if}><a href="{$this->Html->url('/newsletter/viewMailMessage')}">{t}Create new{/t}</a></li>
		</ul>
	...
	{elseif $method eq "mailgroups"}
		...
		<ul class="menuleft insidecol">
			<li><a href="{$this->Html->url('/newsletter/viewMailGroup/')}">{t}Create new list{/t}</a></li>
		</ul>
