...
{$this->Html->script('jquery/jquery.uploadify.min', false)}
...
<!--
var webroot = "{$this->Html->webroot}";
var multiUploadUrl = "{$this->Html->url('/')}files/upload";
var u_id = "{$this->Session->read("BEAuthUser.id")}";
