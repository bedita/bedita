...
var urlDelete = "{$this->Html->url('deleteCategories/')}";
...
$(document).ready(function(){
	...
	<table class="indexlist">
		...
		<form id="form_{$cat.id}" method="post" action="{$this->Html->url('saveCategories')}">
		...
		<form method="post" id="addCat" action="{$this->Html->url('saveCategories')}">
