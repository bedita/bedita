...
var urlLoadNote = "{$this->Html->url('/pages/loadNote')}";
var urlDelNote = "{$this->Html->url('/pages/deleteNote')}";
...
{if !empty($object)}
	...
	{strip}
		...
		<tr>
			...
			<td><img src="{$this->Html->webroot}img/iconNotes.gif" alt="notes" /></td>
		</tr>
		</table>
		<form id="saveNote" action="{$this->Html->url('/pages/saveNote')}" method="post">
