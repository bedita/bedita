...
var urlDelete = "{$this->Html->url('deleteCustomProperties/')}";
...
<div class="mainfull">
	...
	<table class="indexlist">
		...
		{foreach from=$properties item="p"}
			<form id="form_{$p.id}" action="{$this->Html->url('/admin/saveCustomProperties')}" method="post">
	...
	<form action="{$this->Html->url('/admin/saveCustomProperties')}" method="post">
