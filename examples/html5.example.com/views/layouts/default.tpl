...
<body>
	...
	{$beFront->stats()}
	{* jQuery 1.7.1 *}
	{$javascript->link('http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js')}
	<script>window.jQuery || document.write('<script src="{$html->webroot}js/libs/jquery-1.7.1.min.js"><\/script>')</script>
	{* Zepto 0.8 *}
	{*
	{$javascript->link('http://cdnjs.cloudflare.com/ajax/libs/zepto/0.8/zepto.min.js')}
	<script>window.Zepto || document.write('<script src="{$html->webroot}js/libs/zepto-0.8.min.js"><\/script>')</script>
	*}
