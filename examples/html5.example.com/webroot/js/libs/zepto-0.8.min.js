...
(function($){
  ...
  // *Arguments:*
  //
  //     options Ñ object that configure the request,
  //               see avaliable options below
  //
  // *Avaliable options:*
  //
  //     url     Ñ url to which the request is sent
  //     success Ñ callback that is executed if the request succeeds
  //     error   Ñ callback that is executed if the server drops error
  //     context Ñ in which context to execute the callbacks in
  //
  // *Example:*
  //
  //     $.ajaxJSONP({
  ...
  // *Avaliable options:*
  //
  //     type ('GET')          Ñ type of request GET / POST
  //     url (window.location) Ñ url to which the request is sent
  //     data                  Ñ data to send to server,
  //                             can be string or object
  //     dataType ('json')     Ñ what response type you accept from
  //                             the server:
  //                             'json', 'xml', 'html', or 'text'
  //     timeout (0)           Ñ request timeout
  //     beforeSend            Ñ callback that is executed before
  //                             request send
  //     complete              Ñ callback that is executed on request
  //                             complete (both: error and success)
  //     success               Ñ callback that is executed if
  //                             the request succeeds
  //     error                 Ñ callback that is executed if
  //                             the server drops error
  //     context               Ñ in which context to execute the
  //                             callbacks in
  //
  // *Example:*
  //
  ...
  //
  //     url        Ñ url to which the request is sent
  //     [data]     Ñ data to send to server, can be string or object
  //     [success]  Ñ callback that is executed if the request succeeds
  //     [dataType] Ñ type of expected response
  //                  'json', 'xml', 'html', or 'text'
  //
  // *Example:*
  //
  ...
  // *Arguments:*
  //
  //     obj Ñ object to serialize
  //     [traditional] Ñ perform shallow serialization
  //
  // *Example:*
  //
