...
Note:
The first image you put inside your publication is used as header image.
The image is cropped so if you want to see the entire image then upload a 940x198 px (or multiple) image.
The default WordPress TwentyTen theme is used