...
function smarty_modifier_bbcode2html($message) {
  $preg = array(
	...
	// [page]
    '/\[page(?::\w+)?\]www\.(.*?)\[\/page(?::\w+)?\]/si'        => "<a href=\"http://www.\\1\" target=\"_self\" class=\"ng_url\">\\1</a>",
    '/\[page(?::\w+)?\](.*?)\[\/page(?::\w+)?\]/si'             => "<a href=\"\\1\" target=\"_self\">\\1</a>",
    '/\[page=(.*?)(?::\w+)?\](.*?)\[\/page(?::\w+)?\]/si'       => "<a href=\"\\1\" target=\"_self\">\\2</a>",
    // [img]
    ...
    '/\[list=array(?::\w+)?\](.*?)\[\/list(?::\w+)?\]/s'          => "<ol class=\"ng_list\" style=\"list-style-type:lower-alpha;\">\\1</ol>",
