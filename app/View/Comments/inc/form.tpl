<form action="{$this->Html->url('/comments/save')}" method="post" name="updateForm" id="updateForm" class="cmxform">
...
<table class="bordered">
	...
	<tr>
		...
		<td colspan="3">
			...
			<a href="{$this->Html->url('/')}view/{$o.id}"><span title="{$conf->objectTypes[$o.object_type_id].name}" 
