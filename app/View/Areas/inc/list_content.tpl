...
<!--
var urlAddObjToAss = "{$this->Html->url('/pages/loadObjectToAssoc')}/{$object.id|default:0}/leafs/areas.inc.list_contents_for_section";
var priorityOrder = "{$priorityOrder|default:'asc'}";
var pageUrl = "{$this->Beurl->getUrl('object_type_id')}";
...
<div style="min-height:120px; margin-top:10px;">
	...
	<div id="contents_nav_leafs" style="margin-top:10px; padding:10px 0px 10px 0px; overflow:hidden; border-bottom:1px solid gray" class="ignore">	
		...
		{t}show{/t}
		{assign var="allLabel" value=$this->Tr->t("all", true)}
		{$this->BeToolbar->changeDimSelect('selectTop', [], [5 => 5, 10 => 10, 20 => 20, 50 => 50, 100 => 100, 1000000 => $allLabel])} &nbsp;
		{t}item(s){/t} 
		</div>	
		...
		<div class="toolbar sans" style="text-align:right; padding-left:30px; float:right;">
			...
			{if ($this->BeToolbar->pages()) > 1}
			
				&nbsp;
				
				{$this->BeToolbar->prev('‹ prev','','‹ prev')}
			
				&nbsp;
				
				{$this->BeToolbar->next('next ›','','next ›')}
