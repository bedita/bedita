...
var urlAddObjToAss= "{$this->Html->url('/pages/loadObjectToAssoc/')}{$object.id}";
<!--
...
$(document).ready(function() {
	...
	var optionsFormDownloadRel = {
		...
		url: "{$this->Html->url('/files/uploadAjax/DownloadRel')}"
	};
...
<fieldset id="frmAssocObject">
	...
	<div class="htabcontent" id="relationType_{$rel}">
		...
		rel="{$this->Html->url('/pages/showObjects/')}{$object.id|default:0}/{$rel}/{$object_type_id}" style="width:200px" 
