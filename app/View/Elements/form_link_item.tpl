...
<td>
	<input type="text" class="linkcontent" style="width:140px" name="data[RelatedObject][link][{$objRelated.id}][title]" value="{$objRelated.title|default:''}" />
</td>
<td>
...
<td style="white-space:nowrap">
	<input type="button" class="BEbutton golink" onClick="window.open($(this).attr('href'));" href="{$this->Html->url('/')}webmarks/view/{$objRelated.id}" name="details" value="››" />&nbsp;
