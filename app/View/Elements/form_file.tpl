...
{if ($object.ObjectType.name == "image")}
	...
	{$this->BeEmbedMedia->object($object,$params)}
...
{/if}
	...
	{if !empty($this->Html->params.isAjax)}
	<tr>
		<th>{t}id{/t}:</th>
		<td>
			{$object.id}
