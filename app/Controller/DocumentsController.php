...
class DocumentsController extends ModulesController {
	...
	public function save() {
		...
		$this->saveObject($this->Document);
 		...
 		$this->userInfoMessage(__("Document saved")." - ".$this->request->data["title"]);
		$this->eventInfo("document [". $this->request->data["title"]."] saved");
	 }
	...
	public function autosave() {
		...
		$this->userInfoMessage(__("Document Saved on")."<br/>".$time);
		$this->eventInfo("document [". $this->request->data["title"]."] saved");
	 ...
	 public function delete() {
		...
		$this->userInfoMessage(__("Documents deleted") . " -  " . $objectsListDeleted);
