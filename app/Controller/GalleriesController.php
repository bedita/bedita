...
class GalleriesController extends ModulesController {
	...
	public function save() {
		...
		$this->userInfoMessage(__("Gallery saved") . "<br />" . $this->request->data["title"]);
		$this->eventInfo("gallery ". $this->request->data["title"]." saved");
	}

	public function delete() {
		$this->checkWriteModulePermission();
		$objectsListDeleted = $this->deleteObjects("Gallery");
		$this->userInfoMessage(__("Galleries deleted") . " -  " . $objectsListDeleted);
