...
<?php /*%%SmartyHeaderCode:66697146650534970e3b484-61888939%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '66697146650534970e3b484-61888939',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5053497135e8d5_53953929',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5053497135e8d5_53953929')) {function content_5053497135e8d5_53953929($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include '/home/bato/workspace/github/bedita/bedita-app/vendors/_smartyPlugins/block.t.php';
...
$(document).ready(function(){
	...
	// initial serialized form data used on change page to check if any not saved data is present
	var serializedFormData = $("form#updateForm").serialize();
...
",
	...
	window.onbeforeunload = function () {
		if (serializedFormData !== $("form#updateForm").serialize()) {
