<?php /* Smarty version Smarty-3.1.11, created on 2012-09-11 10:27:06
         compiled from "/home/bato/workspace/github/bedita/bedita-app/views/addressbook/inc/list_objects.tpl" */ ?>
<?php /*%%SmartyHeaderCode:230325729504ef5da532e41-64700261%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7bf4fa7ec4f0abc1393e507cef7953c11daa28bc' => 
    array (
      0 => '/home/bato/workspace/github/bedita/bedita-app/views/addressbook/inc/list_objects.tpl',
      1 => 1347273764,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '230325729504ef5da532e41-64700261',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_504ef5daa01cf9_31649006',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_504ef5daa01cf9_31649006')) {function content_504ef5daa01cf9_31649006($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include '/home/bato/workspace/github/bedita/bedita-app/vendors/_smartyPlugins/block.t.php';
...
";
urls['addToMailgroup'] = "<?php echo $_smarty_tpl->tpl_vars['html']->value->url('addToMailgroup/');?>
";
...
";
var sel_mailgroup_msg = "<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Select a mailgroup<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
";
...
//-->
	...
	<?php $_smarty_tpl->_capture_stack[0][] = array("theader", null, null); ob_start(); ?>
		<tr>
			<th></th>
			<th><?php echo $_smarty_tpl->tpl_vars['beToolbar']->value->order('title','name');?>
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['beToolbar']->value->order('surname','surname');?>
</th>
...
is user<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</th>
			<th><?php echo $_smarty_tpl->tpl_vars['beToolbar']->value->order('email','email');?>
</th>
			<th><?php echo $_smarty_tpl->tpl_vars['beToolbar']->value->order('country','country');?>
</th>
			<th><?php echo $_smarty_tpl->tpl_vars['beToolbar']->value->order('note','Notes');?>
</th>	
		</tr>
...
').slideToggle(); $('.plusminus',this).toggleText('+','-')">
			...
			<td style="text-align:center"><?php if (empty($_smarty_tpl->tpl_vars['objects']->value[$_smarty_tpl->getVariable('smarty',null,true,false)->value['section']['i']['index']]['obj_userid'])){?><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php }?></td>
			<td><?php echo (($tmp = @$_smarty_tpl->tpl_vars['objects']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['email'])===null||$tmp==='' ? '' : $tmp);?>
</td>
			<td><?php echo $_smarty_tpl->tpl_vars['objects']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['country'];?>
</td>
...
" />
		...
		<?php if (!empty($_smarty_tpl->tpl_vars['named_arr']->value['id'])){?>
			<?php $_smarty_tpl->tpl_vars['filter_section_id'] = new Smarty_variable($_smarty_tpl->tpl_vars['named_arr']->value['id'], null, 0);?>
...
" />
	...
	<?php if (!empty($_smarty_tpl->tpl_vars['mailgroups']->value)){?>
		<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
mailgroups<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

		<select id="objMailgroupAssoc" name="data[mailgroup]">
		<option value="">--</option>
		<?php  $_smarty_tpl->tpl_vars['mailgroup'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['mailgroup']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['mailgroups']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['mailgroup']->key => $_smarty_tpl->tpl_vars['mailgroup']->value){
$_smarty_tpl->tpl_vars['mailgroup']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['mailgroup']->key;
?>
		<option value="<?php echo $_smarty_tpl->tpl_vars['mailgroup']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['mailgroup']->value['group_name'];?>
</option>
		<?php } ?>
		</select>
		<input id="assocObjectsMailgroup" type="button" value="<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Add association<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
" /> / <input id="disassocObjectsMailgroup" type="button" value="<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Remove association<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
" />
		<hr />
	<?php }?>
